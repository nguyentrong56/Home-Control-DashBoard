...
class WeatherForecast {
    ...
    */
    async getForecast() {
        let appId = '9e9a7015144e28c4c763dfde36f73d3e';
        let endpoint = `https://api.openweathermap.org/data/2.5/weather?lat=33.757561&lon=-117.986146&appid=${appId}&units=metric`;
